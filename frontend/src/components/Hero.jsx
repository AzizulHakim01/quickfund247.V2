    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="grid max-w-screen-xl px-4 mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
          <h1 className="max-w-2xl capitalize mb-4 text-4xl font-extrabold text-[#00D1A9] tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
          ...
          <p className="max-w-2xl mb-6 font-light mt-4 text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
