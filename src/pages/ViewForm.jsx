...
const ViewForm = () => {
  ...
  const handleSubmit = () => {
    ...
    // You can use a library like axios to send the PDF to your API
  };
      ...
      <div className="">
        <div className="max-w-screen-xl  mx-auto" id="print-content">
          ...
          <div className="border-2 border-[#00d1a9] p-2 rounded-md mt-2">
              ...
              <p className="font-bold text-md"><span>Application date: </span>{formData.date}</p>
              </div>
              ...
              <div className="grid grid-cols-1 gap-4 mt-4 text-md font-medium text-slate-700">
                <p>
                  Average Monthly Gross Income : <span>{formData.monthly_revenue}</span>
                </p>
                <p>
                ...
                <p>
                  Month before Last Revenue : <span>{formData.before_last_month}</span>
                </p>
                <p>
                ...
                <p className={`${formData.history === ""?"hidden":""}`}>History : <span>
                  {formData.history}</span>
                </p>
                <p>
                  State : <span>{formData.state}</span>
                </p>
